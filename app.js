...
veryOldInventors = inventors.filter((entry) => entry.year >=1500 && entry.year < 1600)
...
// Complete the exercise in the space below:
inventorNames = inventors.map(entry => {
...
// Complete the exercise in the space below:
isAdultPresent = devs.some(entry => {return entry.year <= 2024 - 18})
// Check your work:
...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every((entry) => {return entry.year <= 2024-19})
// Check your work:
...
// Complete the exercise in the space below:
commentById = comments.find((entry) => {return entry.id === 823423})
// Check your work:
...
// Complete the exercise in the space below:
idx = comments.findIndex((entry) => {return entry.id === 123523})
// Check your work:
...
// Complete the exercise in the space below:
totalYearsLived = inventors.reduce((yearsLived, inventor) => {return yearsLived + (inventor.passed - inventor.year)},0)
...
// Complete the exercise in the space below:
travelMethodCounts = travelMethods.reduce((acc,entry) => {
